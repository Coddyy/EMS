...
<!--Test Collapse-->            
                                ...
                                <div class="mobile_view">
                                      <div class="topnav" id="Topnav">
                                          ...
                                          <a href="<?php echo base_url('employer/profile'); ?>">Profile</a>
...
<style type="text/css">
  .lable_stl{border: 0px solid red; text-align: left;font-size: 16px;}
                    ...
                    .fixed_top{border:0px solid red;padding-left: 265px;margin-top: -5px;width:50%;margin-bottom: 20px;}
                     .aaa{float:right;margin-top: -40px;margin-right: 10px;}
                  	...
                  	<h3 class="fixed_top"><?=$this->uri->segment("3")==""?'Add':'Update';?> Job</h3>

                        <div class="col-xs-12 col-md-9" style="border:0px solid red;height: 700px;overflow-y: scroll;overflow-x: hidden;margin-top: -20px;">
                  			...
                  			<div class="row">
                  			  ...
                  			  <?=$this->uri->segment("3")==""?'Add':'Update';?> Job</h3></div>
							...
							?>
								...
								<form class="form-horizontal" method="post" action="" id="f1" >
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<label for="exampleInputName2" class="col-sm-4 lable_stl">Exp.(in yrs)<span class="error">*</span>
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<label for="exampleInputName2" class="col-sm-4 lable_stl">Job Type<span class="error">*</span>
										</label>
										<div class="col-sm-8"  style="border: 0px solid red;">
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<label for="exampleInputName2" class="col-sm-4 lable_stl">Indutry<span class="error">*</span>
										</label>
										<div class="col-sm-8"  style="border: 0px solid red;">
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<label for="exampleInputName2" class="col-sm-4 lable_stl" style="">
										Salary:(Rs. in Lacs PA)<span class="error">*</span>
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<select  class="form-control" name="location">
											...
											{
												$is_selected=$ctl->city_name==$profile->location?'selected':'';
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<div class="col-sm-8">
                                            ...
                                            value="<?php echo date('Y-m-d',strtotime($job->lastdate))?>" style="cursor:pointer" >
                              ...
                              ?>
									...
									<div class="form-group" style="padding: 0 40px;">
										...
										<!-- <div class="col-sm-offset-5 col-sm-6"> -->
											...
											<button type="submit" onclick="validate()" name="job_profile" class="next">Submit</button>
										</div>
</form>
											<div class="col-md-5 col-xs-12 col-sm-12" style="margin-top: 10px;">
												
											<!-- <a href="<?php echo base_url('employer/dashboard')?>"	class=""> -->
                      ...
                      <!-- </a> -->
									...
									<div class="form-group" style="padding: 0 20px;">
										...
										<div class="col-sm-offset-5 col-sm-6">
											...
											<button type="submit" onclick="validate()" name="submit" class="button">Submit</button>



											<a href="<?php echo base_url('employer/dashboard')?>"

												class="btn btn-primary button">Cancel</a>
