...
<div class="container">
    <div class="container-fluid">
        <div class="col-sm-12">
             <table class="table table-responsive" style="border-color: gray;">
                <thead>
                    <tr>
                        <th class="text-center ">Services</th>
                        <!-- <th class="text-center">Location</th> -->
                        <th class="text-center ">Price</th>
                        <th class="text-center ">Tax&nbsp&nbsp</th>
                        <th class="text-center " style="margin-left: 20px;" class="text-center">Total</th>
                        <th> </th>
                    </tr>
                </thead>
                <tbody class="well">
                ...
                // $pmurl="https://softcadinfotech.in/payment/isPaymentDone/";//.$userId;
                // $pmdata = file_get_contents($pmurl); // put the contents of the file into a variable
                // // $CheckoutDone = json_decode($pmdata);
                // var_dump($pmdata);
                // if($CheckoutDone == '1')
                // {
                //     echo 'Checkout Done';
                ...
                if($service_details)
                {
                    ...
                    { 
                        ...
                        //echo count($service_details);
                        if($i < (count($service_details ) - 1))
                        {
                            $service_Idarray .= $service_id.'&';
                            $service_Durationarray .= $key->duration.'-';
                        }
                        else
                        {
                            $service_Idarray .= $service_id;
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo $gst;?></td>
                            <td class="col-sm-1 col-md-1 text-center"  ><strong class="total_amount" style="margin-left: " id="<?php echo $total_amount_id; ?>"><?php echo $total_amount; ?></strong></td>
                    ...
                    <?php //echo $service_Durationarray;?>
                </tbody>
            </table>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="https://www.softcadinfotech.in/payment/get_data" method="post">
                                ...
                                <input type="hidden" name="service_id" value="<?php echo $service_Idarray; ?>" />
                                ...
                                <input type="hidden" name="service_duration" value="<?php echo $service_Durationarray; ?>">
...
<?php $effectiveDate = date('Y-m-d H:i:s', strtotime("+3 months", strtotime($effectiveDate))); ?>
