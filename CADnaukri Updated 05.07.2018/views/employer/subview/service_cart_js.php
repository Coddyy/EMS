             ...
             <table class="table table-responsive" style="border-color: gray;">
                <thead>
                    <tr>
                        ...
                        <th class="text-center ">Quantity&nbsp&nbsp</th>
                    ...
                    <tr>
                       ...
                       <!--  <td class="col-sm-1 col-md-1" style="text-align: center">
                        ...
                        $months= array('100' => '1 Month','150' => '2 Months','200' => '3 Months','250' => '4 Months','300' => '5 Months','350' => '6 Months','400' => '7 Months','450' => '8 Months','9500' => '9 Months','550' => '10 Months'); ?>
                            ...
                            <select style="width:100%;" name="quantity" id="<?php echo $quantity_id;?>" onchange="calculate(this)" required="" data-service_id="<?php echo $service_id;?>">
                            <?php foreach ($months as $key => $value) {

                                echo '<option class="quantity" data-quantity='.$value.' value="'.$key.'"><span style="margin-bottom:50px;">'.$value.'</span></option>';
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="https://www.softcadinfotech.in/payment/get_data" method="post">
                                ...
                                <input type="hidden" id="payment_service_amount" name="service_amount" value="1" />
...
// $url="https://softcadinfotech.in/payment/api";
