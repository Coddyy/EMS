...
.se-pre-con {
 ...
 <body onload="signOut();"><div class="se-pre-con"></div>
<!--Top bar-->
            <!-- <style>
                    body {margin:0;}
...
<?php //echo $segment; ?>        
          ...
          <div class="row " align="center">
            <div class="col-md-3 col-xs-1"></div>
              <div class="col-md-6 col-xs-10 top_">
                Are you an employer? <a href="<?php echo base_url();?>employer/login" class="top_login">Login here</a>
              </div>
            <div class="col-md-3 col-xs-1"></div>
          </div>
      ...
      Please check your SPAM folder if necessary
                  ...
                  <div style="display:none;" class="alert alert-info" id="emailalreadyregistered">
...
<h1 style="color: #0055A5;padding:0px 10px;font-size: 24px;text-align: center; margin-top:15px;margin-bottom: 10px; border:0px solid;">Candidate Login</h1>
  <form class="form-inline" style=" border:0px solid;margin-left: 5px;"  id="form2" name="form2" method="post" action="" enctype="multipart/form-data">
    <div class="form-group" style="border:0px solid red;">
      <label for="email" class="" style="color:#000;">Email:</label>
      <input type="email" class="form-control span3" placeholder="Enter email" style="min-width: 150px" name="email_id" id="email_id" required=""/ >
    </div>
    <div class="form-group" style="border:0px solid red;">
      <label for="pwd" class="" style="color:#000;">Password:</label>
      <input type="password" class="form-control span3" placeholder="Enter password" style="min-width: 150px" name="password" id="password" required="" />
    </div>
    <button type="submit" class="btn btn-default btn_submit" style="" name="login" id="button2">Log in</button>
    <!-- <div class="checkbox">
      <label style=""> <input type="checkbox">  Remember me</label>
    </div> -->
    <style type="text/css">
      .forgot_password {float:right; color:#0055A5;}

      .forgot_password:hover{color: #FF6600;text-decoration: none;}
    </style>
    <div style="display: ;" class="g-signin2" data-onsuccess="onSignIn"></div>
    <label for="checkbox3" style="margin-top: 10px; margin-left: -4px;color: #000;">                              
                              <input type="checkbox"  name="checkbox3" id="checkbox3" style="" /> Remember me                               
                              <a class="forgot_password" style="" href="<?php echo base_url('candidate/forgot_password')?>">Forgot Password?</a>
              ...
              if($this->session->flashdata('sucess')){
                 ...
                 <br/>
                 <?php } ?>
                          <h2 style="color: #0055A5;padding:0px 10px;font-size: 24px;text-align: center;border-bottom: none;">Create your free account<!-- Candidate Registration --></h2>
                  ...
                  <div class="span3 " style="">
                       <form style="" id="f1" action="<?php echo base_url();?>signup/sign_up" method="post" >
...
By clicking Create an account, you agree to our<a href="<?php echo base_url();?>Terms-And-Conditions" class="pa"> Terms and conditions</a> that you have read our<a href="<?php echo base_url();?>Privacy-Policy" class="pa"> Privacy Policy </a>. You may receive SMS message notifications from Facebook and can opt out at any time.</label>
                          ...
                          <center><button class="btn btn-success btn_signup" onclick="validate()" type="submit" style="">Sign up</button>
                           <button class="btn btn-default btn_reset" type="reset" style=""> Reset </button></center><br>
                           <input type="hidden" name="segment" value="<?php echo $segment; ?>"></input>
                       </form>
