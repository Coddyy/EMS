...
<h3 class="desk_mov"><b>  Applied Jobs</b></h3>
                        <div class="col-xs-12 col-md-9" style="height: 600px;overflow-y: scroll;">
                  			<div class="xcolleft">
                        	  
<?php foreach ($applied_jobs as $key) { ?>
                    ...
                    <h4 class="h3_title" style="" title="Job title - CADnaukri.com"><?php echo $key->jobtitle; ?></h4>
						                ...
						                <div class="media-body" >
						                    <!-- <div class="col-lg-12 padding-left-0">
						                    	...
						                    	<ul class="list-inline list-unstyled" >
						                          	<li style="font-size: 18px;"><b><span class="glyphicon glyphicon-briefcase" id="glyphicon" style="" title="Experience - CADnaukri.com" ></span></b><?php echo $key->yop; ?>&nbspYrs</li>
						                     		<li style="font-size: 18px;"><b><span class="glyphicon glyphicon-map-marker" id="glyphicon" style="" title="location - CADnaukri.com" ></span></b><?php echo $key->location; ?></li>
