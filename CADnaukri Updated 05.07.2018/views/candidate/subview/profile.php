...
<section id="sign_up_form">
	...
	Change your profile  which will help you to find a better partner</span></h2>
	...
	<?php } ?>
		...
		<form class="form-horizontal" role="form" action="<?php echo base_url('user/profile')?>" method="post" id="sign_up_form" onsubmit="return submit_signup()" enctype="multipart/form-data">
		<input type="password" id="" name="" placeholder="" VALUE=""/>
		 <div class="row">
		<div class="col-md-3 col-sm-3 col-md-offset-2">
              <div class="defult_img"> 
						<img src="<?php echo base_url() ?>assets/img/emp.png" alt=""> 
              </div>
             
		 </div>
		 <div class="col-sm-7 col-md-7"> 
		 	 <input type="file" name="fileToUpload" id="fileToUpload" class="image_uploader" >
		 </div>
		</div>
		  <div class="row">
		   <div class="row">
				...
				<div class="form-group ">
				  ...
				  <div class="col-sm-9">
					 	<?php foreach($sportstype as $st){
					 		if(in_array($st->id,$user_preferred_sports))
					 		{
								$checked='checked';
							}
							else
						...
						<li class="prefereedsports" style="list-style-type:none">
								...
								value="<?php echo $st->id?>" <?php echo $checked ?>> <?php echo ucfirst( $st->sportstype)?></label>
						</li>
						</div>
						<?php } ?>
