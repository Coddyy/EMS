...
<!--Test Collapse--> 
                        ...
                        <div class="col-md-9 col-xs-12">
                  			<div class="xcolleft">
                        	<h1 class="desk_mov"><b>Upload your latest CV</b></h1>  
							 ...
							 <!--  <div class="row">
							  ...
							  <?php } ?>
<style type="text/css">
  .updatecv{border:0px solid red;border-radius: 4px; padding: 20px 20px;background-color: #DFF0D8;}
  .deactive{background-color:#0055A5;border:none;padding: 5px 30px; }
  .deactive:hover{background-color:#ff7900;border:none; }
</style>

							  <div class="row updatecv" style="" align="center">
							  	  	<label for="exampleInputName2" class="col-sm-5 col-xs-4 control-label" align="right">Update CV</label>
									<div class="col-md-7 col-xs-8" align="left">

        <form action="<?php echo base_url();?>candidate/cvupload" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12 col-xs-12" style="">
                            <strong> You are requested to upload .doc .docx .pdf & .rtf documents of less then 2MB only.</strong>
                          </div>
                <div class="col-md-12 col-xs-12" style="margin-top: 20px;">
                  <center><input type="submit" name="button" id="button" value="Save" class="btn btn-primary save" style="height: 30px;" />
                  <input type="hidden" name="hidden_id" value="<?php echo $this->session->userdata('candidate_id');?>"></input></center>
                </div>
        </form>
							  </div><br><br>
                <style type="text/css">
                ...
                <div class="row">
                  <h1 class=desk_mov><b  style="margin-left: 20px;">Deactivate your profile</b></h1>
                  <div class="col-md-12 col-xs-12 col-sm-12">
                   <center> <strong></strong><span>&nbsp &nbsp</span><br><br>
                   <?php if($this->session->userdata('candidate_id'))
                          {
                            $candidate_id=$this->session->userdata('candidate_id');
                          
                   if($this->Candidate_M->get_profile_status($candidate_id) == '1')
                   { ?>
                    <a href="<?php echo base_url();?>candidate/change_profile_status/0/<?php echo $candidate_id;?>"<button type="button" class="btn btn-primary deactive" name="" >Activate Now</button></a>
                  <?php } else{ ?>
                    <a href="<?php echo base_url();?>candidate/change_profile_status/1/<?php echo $candidate_id;?>"<button type="button" class="btn btn-primary deactive" name="">Deactivate Now</button></a>
                  <?php   } } ?>
                  ...
                  <span style="line-height: 50px;color:orangered;"><strong>N.B :-</strong>  Deactivating your profile will hide your visibility to employers.</span>
