...
<div class="container-fluid">
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" style="background-color: #FF7900;height: 14px;margin-top: -20px;margin-bottom: 10px;">
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12" style="border: 0px solid blue; background-color: #FF7900;height: 14px;margin-top: -20px;margin-bottom: 10px;"> 
              <div class="dropdown">
...
<style type="text/css">
  ...
  @media screen and (max-width: 768px){
    ...
    .no_opacity{width: 180px;height: 180px;border: 1px solid #ccc;padding: 5px;border-radius: 4px;}                        
                        ...
                        <div class="col-md-9 col-xs-12 " style="border: 0px solid red;">
                        <div id="my_profile" >
                        <div class="xcolleft"> 
                      ...
                      <h1 class="h1_titel" style="border:1px solid green;">Contact Details</h1>
                     <div class="row" style=" border:1px solid orange;">                      
                      <div class="col-xs-12 col-md-12 box_margin">                     
                      
                      <!-- <div class="row" style=" border:1px solid blue;padding-top: 1%"> -->
                            <div class="col-md-4 col-md-offset-1 col-xs-offset-1 col-xs-10" style="font-weight: bold;border:1px solid red;">
                                 Mobile
                            </div>
...
<?php foreach ($edu_details as $key) { ?>
  ...
  <h1 class="h1_titel" style="border: 1px solid red;">Experience Details</h1>
   ...
   <?php foreach ($exp_details as $key) { ?>
                     <div class="row">  
                      ...
                      <div class="col-xs-12 col-md-12 box_margin" style="border: 1px solid blue;">                     
                      
                       <div class="row" style="padding-top: 1%">
                            <div class="col-md-4 col-md-offset-1 col-xs-offset-1 col-xs-10" style="font-weight: bold;border: 1px solid red">
                                 Designation
                            </div>
                                  <div class="col-md-1 col-xs-1 desktop" style="border: 1px solid red;">:</div>
