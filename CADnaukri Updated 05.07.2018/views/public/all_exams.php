...
<div class="container" style="border: 1px solid #00A8FF;border-radius: 4px;padding-top: 2%;">
	<div class="row" style="border: 0px solid #ccc;">
		<div class="col-sm-6">
			<ul class="sidebarservices col-sm-12 well"  style="padding: 2%;">
				<li class="head  well" style="text-align: center;background-color:#d9ffb3; "><b style="color:#00A8FF;">Upcoming Exams</b></li>
				<?php 
				...
				?>
		        		<li style="padding-left:2%;"><h4><span style="color:blue;"><?php echo $key->company_name;?></span> Hiring <span style="color:orange;"><?php echo $key->hiring_for;?></span>&nbsp&nbsp<span style="font-size:12px;color:white;background-color: green;">&nbsp<?php echo date('d F',strtotime($key->start_date));?>&nbsp</span></h4>
		        <!-- <?php 
		...
		<div class="col-sm-6"style="background-color: white;">
			<ul class="sidebarservices col-sm-12 well" style="padding: 2%;">
				<li class="head  well" style="text-align: center;background-color:#d9ffb3; padding: 0px;"><b style="color:#00A8FF;">Top Qualifiers</b></li>
		        <?php 
					...
					{ 
						...
						//echo $key->exam_details_id;
				?>
						<li style="padding-left: 2%;"><?php echo $key->name;?></li>
	...
	<div class="row" style="border: 0px solid #ccc;">
		<div class="col-sm-6">
			<ul class="sidebarservices col-sm-12 well"  style="padding: 2%;">
				<li class="head well" style="text-align: center;background-color:#d9ffb3; padding: 0px;"><b style="color:#00A8FF;">Ongoing Exams</b></li>
		        <?php 
					foreach ($ongoing_exams as $key) 
					{ 
		        ...
		        <?php 
            		...
            		{
            	?>
            			<a class="pull-right" href="<?php echo base_url();?>candidate/give_exam_now/<?php echo $key->exam_details_id;?>"><span class="btn btn-primary pull-right" style="width: 30px;">Start</span></a>
            	<?php 	
            		}
            		else
            		{ 
		...
		<div class="col-md-6 col-xs-12 col-lg-6 col-sm-12">
			<ul class="sidebarservices pull-right">
