...
@media screen and (max-width: 768px){
	.banner_img{margin-top: 10px;height: auto;}
...
<div class="container" style="border:0px solid grey;max-width: 1000px;background-color: #fff;">
	<div class="row" style="">
		<div class="col-md-3 col-xs-12" align="center">
			<img src="<?php echo base_url()?>assets/images/img/Logo-1-min.jpg" alt="CADnaukri" height="65">
		</div>
		...
		<div class="col-md-9 col-xs-12" align="" >
			...
			<div class="row" style="height: 26px;">
				...
				<span class="col-md-3 col-xs-4" style="">
					<button type="button" class="btn btn-info pull-right sign_up blink" title="Sign Up">Add Your Listing</button>
				</span>
			</div>

			<div class="row" style="background-color: #0055A5; margin-top: 0px; border-radius: 4px;">
...
<!--Desktop-->
	<div class="row desktop" style="">
		<div class="col-md-9 col-xs-12 image">
			<div class="col-md-12 col-xs-12" style="font-size: 18px;font-weight: 500;">Company Name:-</div>
			<div class="col-md-12 col-xs-12 div_icon"><span class="glyphicon glyphicon-home icon_list" style="" title="Address"></span>Address
				Paragraph writing remains one of the most important parts of writing.  </div>
			<div class="col-md-12 col-xs-12 div_icon"><span class="glyphicon glyphicon-pushpin icon_list" style="" title="Pin code"></span>Pin code
			</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-map-marker icon_list" style="" title="Location"></span>Location:-</div>

			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-calendar icon_list" style="" title="Estd Year"></span>Estd.</div>
			...
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-phone icon_list" style="" title="Mobile"></span>+12345678912</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-phone-alt icon_list" style="" title="Landline"></span>+12345678912</div>
			...
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-globe icon_list" style="" title="website"></span>website</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-envelope icon_list" style="" title="Email"></span>Email</div>
			...
			<div class="col-md-12 col-xs-12 div_icon" style="color:grey; font-weight: 400"><span class="glyphicon glyphicon-book icon_list" style="" title="Course Offered"></span><i>Course Offered</i><br>
				...
				<ul class="">
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CREO AUTOCAD</i></li>
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CATIA AUTOCAD</i></li>
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span>  <i>Revit Architecture</i></li>
				
		
				
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CREO AUTOCAD</i></li>
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CATIA AUTOCAD</i></li>
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span>  <i>AUTOCAD AUTOCAD</i></li>
				
				
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CREO</i></li>
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CATIA</i></li>
					<li class=" list_tag col-md-4 col-xs-6" style="display: inline-block;"><span class="glyphicon glyphicon-tag icon_list_inner"></span>  <i>AUTOCAD</i></li>
				</ul>
				</div>
			</div>
...
<!--Mobile View-->
	<div class="row mobile" style="">
		<div class="col-md-9 col-xs-12 image">
			<div class="col-md-12 col-xs-12" style="font-size: 18px;font-weight: 500;">Company Name:-</div>
			<div class="col-md-12 col-xs-12 div_icon"><span class="glyphicon glyphicon-home icon_list" style="" title="Address"></span>Address Paragraph writing remains one. </div>
			<div class="col-md-12 col-xs-12 div_icon"><span class="glyphicon glyphicon-pushpin icon_list" style="" title="Pin code"></span>Pin code</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-map-marker icon_list" style="" title="Location"></span>Location:-</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-calendar icon_list" style="" title="Estd Year"></span>Estd.</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-phone icon_list" style="" title="Mobile"></span>+12345678912</div>
			<div class="col-md-6 col-xs-6 div_icon"><span class="glyphicon glyphicon-phone-alt icon_list" style="" title="Landline"></span>+12345678912</div>
			...
			<div class="col-md-12 col-xs-12 div_icon" style="color:grey; font-weight: 400;border:0px solid red;">
				...
				<span class="pull-left">
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CREO AUTOCAD</i></li>
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CATIA AUTOCAD</i></li>
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span>  <i>Revit Architecture</i></li>
				
		
				
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CREO AUTOCAD</i></li>
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CATIA AUTOCAD</i></li>
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span>  <i>AUTOCAD AUTOCAD</i></li>
				
				
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CREO</i></li>
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span> <i> CATIA</i></li>
					<li class=" list_tag col-xs-6" style="display: inline-block; overflow: ;text-align: left;"><span class="glyphicon glyphicon-tag icon_list_inner"></span>  <i>AUTOCAD</i></li>
				</span>
				<!-- </div> -->
			</div>
