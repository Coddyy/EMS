...
<style type="text/css">
                  .desk_mov{border:0px solid red;margin-top: 0px;}
                  .h3_title{margin-top: -20px;margin-left: -20px;margin-right: -20px;height: 30px; line-height: 30px;vertical-align: middle;background-color:#0055A5;border-radius: 4px;color:#fff;padding-left: 20px;border-bottom-right-radius: 0;border-bottom-left-radius: 0;}
                  @media screen and (max-width: 768px){
                    .desk_mov{text-align: center;}
                  }
                </style>
<!--Start Top bar-->
<style type="text/css">
...
<h3 class="desk_mov"><b>  Applied Internship</b></h3>
                        <div class="col-xs-12 col-md-9" style="height: 600px;overflow-y: scroll;">
                  			<div class="xcolleft">
                        	  
<?php foreach ($applied_internships as $key) { ?>

	                 <div class="container well shadow-z-1 col-md-12" style="background-color: #BFD9E6;border-radius: 4px; border-bottom: 2px solid #999;box-shadow: 5px 5px 5px #cccccc;">
                    <h4 class="h3_title" style="" title="Job title - CADnaukri.com"><?php echo $key->title; ?></h4>
						            <div class="media" style="border:0px solid red;">
						                <div class="media-body" >
						                    <!-- <div class="col-lg-12 padding-left-0">
						                        <h4 class="media-heading" style="color:#0055A5;">
						                        	<?php echo $key->jobtitle; ?>
						                        </h4>
						                    </div> -->
											           <div class="col-lg-12 padding-left-0" >
						                    	<ul class="list-inline list-unstyled" >
						                          	<li style="font-size: 18px;"><b><span class="glyphicon glyphicon-briefcase" id="glyphicon" style="" title="Company - CADnaukri.com" ></span></b><?php echo $key->company_name; ?></li>
						                     		<li style="font-size: 18px;"><b><span class="glyphicon glyphicon-map-marker" id="glyphicon" style="" title="location - CADnaukri.com" ></span></b><?php echo $key->location; ?></li><br />
						                            <li style="font-size: 18px;"><b class="">Applied Date:&nbsp</b><?php echo date('d F Y', strtotime($key->applied_date)); ?>
						                            </li>
						                        </ul>
						                    </div>
						                </div>
...
<br>
   ...
   <style type="text/css">
   	#glyphicon{font-size: 16px;color: #FF7900;padding-right: 7px; padding-top: 5px; height: 10px;display: inline-block;}
   	/*#glyphicon:hover{font-size: 18px;color: #FF7900;}*/
