...
<title>Internship | Update Password</title>
    ...
    <div class="panel panel-primary panel_main">
      <div class="panel-body" style="">
          <div class="panel-heading panel_head">
            <h4 align="center" style="color:#fff;">Update Password</h4>
        </div>
          <div class="panel-body" style="border: 1px solid #0055A5;border-top: none;border-radius: 4px;">
            <?php if($this->uri->segment(2) == "password_updated"){ ?>

              <div class="alert alert-success" role="alert">
                Password successfully updated.
              </div>

            <?php }else if($this->uri->segment(2) == "wrong_password"){ ?>
            ...
            <form class="form-horizontal" action="" method="post" id="f1" onsubmit="return validate()">
              ...
              <label class="control-label col-sm-4" align="left" for="confirm">Current Password</label>
                <div class="col-sm-8">              
                <input class="form-control" placeholder="Current Password" name="current_pass" type="password" value="" required>
              </div>
              </div>
                <div class="form-group">
                <label class="control-label col-sm-4" align="left" for="current">New Password</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
              <label class="control-label col-sm-4" align="left" for="new">Confirm Password</label>
                <div class="col-sm-8">              
