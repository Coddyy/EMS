...
<title>Internship | Quick Apply</title>
<!--Start Top bar-->
<style type="text/css">
...
<style type="text/css">
	/*.con_main{max-width: 600px;margin-top:80px;margin-bottom: 300px; border:1px solid #ccc;box-shadow: 2px 2px 2px 2px #cccccc;border-radius: 4px;}
	.h1_head{border: 1px solid green;background-color: #0055A5;color:#fff;margin:1px;border-radius: 4px;}
	.btn_submit{background-color:#0055A5;color:#fff;}
	.btn_submit:hover{background-color:#FF7900;color:#fff; }*/
  </style>
  <style type="text/css">
  .con_main{max-width: 500px;margin-top:20px;margin-bottom: 20px; border:1px solid #ccc;box-shadow: 2px 2px 2px 2px #cccccc;border-radius: 4px;}
		...
		<form action="" method="post" enctype="multipart/form-data" style="padding:10px;">
            <fieldset style="margin-top: 10px;">
              <label style="text-align: left;">Full Name:</label> 
                ...
                <input type="text" id="email" name="email" class="input-block-level" placeholder="Email" required="">
                <label style="text-align: left;">Mobile:</label> 
                <input type="tel" id="mobile" name="mobile" maxlength="10" class="input-block-level" placeholder="Mobile" required="">
                <label style="text-align: left;">Covering letter:</label> 

                <textarea rows="3" maxlength="150" id="cover_letter" name="cover_letter" class="input-block-level" placeholder="Write a covering letter to the recuriter" ></textarea>
                <br />
                <label style="margin-top: 10px; text-align: left;">Upload Resume</label>
...
<div class="container con_main" style="" align="center">
    <div class="row">
    <h3 align="center" class="h1_head">Apply</h3>
    <small style="color:#FF7900;">Use quick apply for faster and more secure job application.</small>
        <form action="<?php echo base_url();?>internship/apply/<?php echo $this->uri->segment(3);?>" method="post" enctype="multipart/form-data" style="padding:10px;">
            <fieldset style="margin-top: 10px;">
              <label style="text-align: left;">Full Name:</label> 
                ...
                <label style="margin-top: 10px;">Resume : 
                <?php echo $resume;?></label>
        ...
        <a href="<?php echo base_url();?>" class="pull-right">  <button type="button" style="" class="btn btn_back">Home</button> </a>
        </center>
        </fieldset>
    </div>
</div>
