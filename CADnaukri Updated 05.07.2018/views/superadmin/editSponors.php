<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url('superadmin/sponors/index')?>">Sponors</a> <span class="divider">/</span>
					</li>
                                        <li>
						<a href="<?php echo base_url('superadmin/sponors/editSponors')?>">Edit Sponors</a> <span class="divider">/</span>
					</li>
				</ul>
			</div>
		...
		<?php } ?>
                                 ...
                                 <form  name="registration" action="<?php echo base_url('superadmin/sponors/updateSponors ')?>"  method="post"   enctype="multipart/form-data">			
