...
<script>
 ...
 <style type="text/css">
      ...
      @media screen and (max-width: 786px){
        .logonew{
           margin-top: 0px;margin-bottom: 0px;border:0px solid;height: 43px;width: 216px;margin-left: 0px;
        }
      }
  ...
  <!-- <div class="main-container">
    <div class="top-header"> -->
      <div class="container" style="width: 100%;border:0px solid green ;">
        <div class="row">
                <div class="col-md-3 col-xs-12" style="border:0px solid red;">
                        <div id=""><a href="<?php echo base_url();?>">
                          <img src="<?php echo base_url()?>assets/images/CADnaukri_Header-Logo1.jpg" alt="CADnaukri" class="logonew" style=""></a>
                        </div>   
                    </div>
