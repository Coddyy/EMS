<?php include('header.php'); ?>
			...
			<div>
				<ul class="breadcrumb">
					<li>
						<a href="<?php echo base_url('superadmin/index/dashboard')?>">Home</a> 
					</li>
			...
			<div class="sortable row-fluid">
				...
				<span data-rel="tooltip"  class="well span3 top-block" href="#">
					...
					<div><?php echo $result?></div>
                                        ...
                                        $new_cand=$this->SuperAdmin_M->newCandidate();
                                        if($new_cand <= 0)
                                        {
                                        	$url='#';
                                        }
                                        ...
                                        {
                                        	$url=base_url().'superadmin/index/new_candidates';
                                        }
                                        ?>
                                        
					<a href="<?php echo $url ?>" ><span class="notification green"><?php echo $new_cand;?></span></a>
				</span>
				...
				<span data-rel="tooltip"  class="well span3 top-block" href="#">
					...
					<div><?php echo $result?></div>
                                        ...
                                        $new_emp=$this->SuperAdmin_M->newEmployee();
                                        if($new_emp <= 0)
                                        {
                                        	$url='#';
                                        }
                                        ...
                                        {
                                        	$url=base_url().'superadmin/index/new_employers';
                                        }
                                        ?>
                                        
					<a href="<?php echo $url ?>" ><span class="notification red"><?php echo $new_emp?></span></a>
				</span>
				...
				<span data-rel="tooltip"  class="well span3 top-block" href="#">
					...
					<div><?php echo $result?></div>
                                        ...
                                        $new_intern=$this->SuperAdmin_M->newIntern();
                                        if($new_intern <= 0)
                                        {
                                        	$url='#';
                                        }
                                        ...
                                        {
                                        	$url=base_url().'superadmin/index/new_interns';
                                        }
                                        ?>
                                        
					<a href="<?php echo $url ?>" ><span class="notification orange"><?php echo $new_intern;?></span></a>
				</span>
...
<a href="<?php echo base_url();?>superadmin/candidate/shoot_mail"><button class="btn btn-danger">Emergency Mailer [ Candidate ]</button></a>

<a href="<?php echo base_url();?>superadmin/candidate/cv_updated_candidates"><button class="btn btn-info">Updated Candidates [ CV ]</button></a>
