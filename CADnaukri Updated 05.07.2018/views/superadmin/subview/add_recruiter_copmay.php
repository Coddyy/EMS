...
<div class="row-fluid sortable">
      <div class="box span12">
		 <div class="box-header well" data-original-title>
               ...
               <h2><i class="icon-edit"></i>Add Recuiter Details(For Home Page )</h2>
			 ...
			 <?php } ?>
	           ...
	           <form  name="registration" action=""  method="post"   enctype="multipart/form-data">	
	                  ...
	                  <div class="control-group">		
	                       <label for="exampleInputName2" class="span4 control-label">Name Of Recuiter</label>
	                           <div class="controls ">	
	                    ...
	                    <div class="control-group">
						 ...
						 <div class="control-group">		
	                       <label for="exampleInputName2" class="span4 control-label">Recuiter Home Link</label>
	                           <div class="controls ">	
