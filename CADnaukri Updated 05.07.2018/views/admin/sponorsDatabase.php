...
<div>
	<ul class="breadcrumb">
		<li>
			<a href="<?php echo base_url('admin/index/index')?>">Home</a> <span class="divider">/</span>
		</li>
		<li>
			<a href="<?php echo base_url('admin/sponors/index')?>">CAD CAM centers</a> 
		</li>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					...
					<a href="<?php echo base_url()?>admin/CAD-CAM-Schools/Register" class="btn btn-warning">
                                            ADD CAD CAM center
                                        </a>
				</div>
					</div>
                                ...
                                <td class="center"><div style="border-radius:2px;color:white;text-align:center;background-color: <?php echo $color; ?>;">&nbsp&nbsp<?php echo $status;?>&nbsp&nbsp</div></td>
								 ...
								 <?php if($status == 'Active'){ ?>
								 	<a class="btn btn-danger" 
										href="<?php echo base_url('admin/sponors/stop_publish/'.$value->id)?>"
										<i class="icon-edit icon-white"></i>Deactive
									</a>
								 <?php } else {  ?> 
								 	<a class="btn btn-success" 
										href="<?php echo base_url('admin/sponors/publish_now/'.$value->id)?>"
								 ...
								 <?php } ?>
									...
									<a class="btn btn-info" 
										href="<?php echo base_url('admin/sponors/sponorsEntry/'.$value->id)?>"
										<i class="icon-edit icon-white"></i>Edit </a>
										<a class="btn btn-warning" 
										href="<?php echo base_url('admin/sponors/deleteSponors/'.$value->id)?>"
										<i class="icon-edit icon-white delete"></i>Delete </a>
