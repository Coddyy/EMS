...
<!--col-md-9 Start-->
  ...
  @media screen and (max-width: 768px){
    ...
    .no_opacity{width: 180px;height: 180px;border: 1px solid #ccc;padding: 5px;border-radius: 4px;}                        
                 ...
                 <div class="row pull-right" style="padding-top: 1%;padding-bottom: 1%">
                         
                           <a href="<?php echo base_url();?>superadmin/employee/download_profile_details/<?php echo $this->uri->segment(4);?>" target="_blank" > <button class="btn btn-primary print-link no-print signup">Download Profile</button></a>
                           <center>
                           <p>&nbsp&nbsp</p>
