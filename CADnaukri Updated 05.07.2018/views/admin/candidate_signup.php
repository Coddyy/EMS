...
<div class="row-fluid sortable">
	...
	<div class="box-header well" data-original-title>
        ...
        <div class="box-content">
            <form class="form-horizontal" name="registration" action="<?php echo base_url('admin/candidate/insertData')?>"  method="post"   enctype="multipart/form-data">
           ...
           <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                  <input type="tel" class="form-control" id="phoneno" name="phoneno"  placeholder="e.g. 8895679043">
                </div>
