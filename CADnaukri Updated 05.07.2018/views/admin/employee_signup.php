<?php include('header.php'); ?>
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url()?>admin/employee/index">Employee</a> <span class="divider">/</span>
                                        ...
                                        <li>
						<a href="<?php echo base_url()?>admin/employee/signup">Employee Sign Up</a> <span class="divider">/</span>
					</li>
				</ul>
			</div>
		...
		<?php } ?>
                                 <fieldset>
                                 <form  name="registration" action="<?php echo base_url('admin/employee/empdata')?>"  method="post"   enctype="multipart/form-data">			
						 ...
						 <?php echo form_error('mobile', '<div class="error">', '</div>'); ?>	
                            ...
                            <div class="control-group">	
                                ...
                                <div class="controls">			
                                    <input type="text" class="input-xlarge  form-control" id="role" name="role" onblur="allLetterrd()" placeholder="Roles and Designation">	
