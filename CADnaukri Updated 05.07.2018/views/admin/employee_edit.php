				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url()?>admin/employee/index">Employee</a> <span class="divider">/</span>
                                        ...
                                        <li>
						<a href="<?php echo base_url()?>admin/employee/signup">Employee Edit</a> <span class="divider">/</span>
					</li>
				</ul>
			</div>
                             ...
                             <div class="box-content">
                                 ...
                                 <fieldset>
                                    ...
                                    // print_r($empsingleList);
                                     ...
                                     ?>
                                 <form  name="registration" action="<?php echo base_url('admin/employee/empUpdate')?>"  method="post"   enctype="multipart/form-data">			
				   <input type="hidden" class="input-xlarge form-control"  name="id" value="<?php echo $id?>">		
						 ...
						 <?php echo form_error('mobile', '<div class="error">', '</div>'); ?>	
                            ...
                            <div class="control-group">	
                                ...
                                <div class="controls">			
                                    <input type="text" class="input-xlarge  form-control" id="role" name="role" value="<?php echo $roles?>" placeholder="Roles and Designation">	
					...
					<div class="controls">
						<select name="nationality" class="input-xlarge  form-control" onblur="countryselect()">
                                                    <option value="<?php echo $nationality?>" selected><?php echo $nationality?></option>
